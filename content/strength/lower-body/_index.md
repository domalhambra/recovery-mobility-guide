...
menuPre: "32 "
weight: 20
description: "Lower body strength exercises."
---
...
{{< tabs >}}
{{% tab title="Squat and Hinge Are King" %}}
...
{{% /tab %}}
{{% tab title="Depth Requires Mobility" %}}
Can't hit parallel on squats? The fix usually isn't more squatting — it's more mobility work. Ankle dorsiflexion, hip flexion, and thoracic extension all contribute to squat depth. Pair training with exercises from [Lower Body Mobility](../../mobility/lower-body/).
{{% /tab %}}
{{% tab title="Unilateral Work Prevents Imbalance" %}}
