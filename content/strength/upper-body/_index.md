...
{{% /tab %}}
{{% tab tabName="Shoulder Health First" %}}
The shoulder joint trades stability for mobility. Heavy pressing without adequate warm-up and mobility work is the fastest route to impingement. Always warm up with [upper body mobility](../../mobility/upper-body/) before pressing, and include rotator cuff work weekly.
{{% /tab %}}
{{% tab tabName="Grip Strength Is Foundational" %}}
