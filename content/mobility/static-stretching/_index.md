---
title: "Static Stretching & Flexibility"
weight: 60
...
{{< tabs tabTotal="3" >}}
{{% tab tabName="Timing Matters" %}}
Static stretching before intense activity can temporarily reduce power output and muscle activation. Save long holds for after training, in the evening, or as a standalone flexibility session. For pre-workout prep, use the [dynamic warm-ups](../../warm-up/) instead.
{{% /tab %}}
{{% tab tabName="Duration Drives Adaptation" %}}
