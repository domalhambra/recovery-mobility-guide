---
title: "CARs & Joint Maintenance"
weight: 40
description: "Controlled articular rotations and daily joint maintenance."
---
...
{{< tabs tabTotal="3" >}}
{{% tab tabName="Daily Non-Negotiable" %}}
...
{{% /tab %}}
{{% tab tabName="Slow and Controlled" %}}
...
{{% /tab %}}
{{% tab tabName="Irradiation Creates Isolation" %}}
