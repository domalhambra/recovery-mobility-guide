...
{{< tabs tabTotal="3" >}}
{{% tab tabName="Principles Over Programs" %}}
...
{{% /tab %}}
{{% tab tabName="Simple Beats Complex" %}}
...
|---------|---------------|
| [**Foam Rolling Basics**](foam-rolling-basics/) | Technique, duration, and when to use self-myofascial release |
| [**Progressive Overload for Mobility**](progressive-overload-for-mobility/) | How to systematically increase mobility demands over time |
| [**When to Stretch vs. Strengthen**](when-to-stretch-vs-strengthen/) | The decision framework for choosing the right intervention |
