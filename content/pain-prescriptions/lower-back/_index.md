...
weight: 10
description: "Lower back pain prescriptions and correctives."
---
...
{{< tabs tabTotal="3" >}}
{{% tab tabName="Hips and Core Are Usually Involved" %}}
...
{{% /tab %}}
{{% tab tabName="Movement Is Medicine" %}}
...
{{% /tab %}}
{{% tab tabName="Know the Red Flags" %}}
...
|---|----------|-------------|
| 51.01 | [Lower Back Pain Prescriptions](lower-back-pain/) | Multi-step protocol: soft tissue, mobilization, and movement resets |
