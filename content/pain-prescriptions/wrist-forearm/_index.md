---
title: "Wrist & Forearm Pain"
weight: 40
description: "Wrist and forearm pain prescriptions."
---
...
{{< tabs tabTotal="3" >}}
{{% tab tabName="Tissue Density Is the Issue" %}}
...
{{% /tab %}}
{{% tab tabName="Upstream and Downstream" %}}
...
{{% /tab %}}
{{% tab tabName="Progressive Loading Heals Tendons" %}}
...
|---|----------|-------------|
| 54.01 | [Wrist Pain & Carpal Tunnel](wrist-pain-carpal-tunnel/) | Forearm release, nerve gliding, and wrist mobilization protocol |
