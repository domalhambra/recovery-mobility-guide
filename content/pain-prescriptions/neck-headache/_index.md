...
title: "Neck & Headache"
weight: 20
description: "Neck pain and headache prescriptions."
---
...
{{< tabs tabTotal="3" >}}
{{% tab tabName="The Culprit Is Usually Below" %}}
...
{{% /tab %}}
{{% tab tabName="Tension Headaches Respond to Release" %}}
...
|---|----------|-------------|
| 52.01 | [Headache & Neck Pain](headache-neck-pain/) | Multi-step protocol for tension headaches and cervical pain |
