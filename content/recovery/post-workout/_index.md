...
weight: 20
description: "Post-workout recovery protocols."
---
...
{{% /tab %}}
{{% tab tabName="Target What You Trained" %}}
...
{{% /tab %}}
{{% tab tabName="Static Stretching Fits Here" %}}
...
|---|----------|-------------|
| 42.01 | [Post-Workout Recovery](post-workout-recovery/) | General post-training cooldown and recovery sequence |
