---
title: "Pre-Shift Warm-Ups"
weight: 10
description: "Pre-shift and pre-mo warm-up sequences."
---
...
{{% /tab %}}
{{% tab tabName="Quick and Standing" %}}
...
{{% /tab %}}
{{% tab tabName="Pair with Post-Shift" %}}
Pre-shift warm-ups prepare you for the work; [post-shift recovery](../../recovery/post-shift/) undoes the damage. Using both creates a bookend system that prevents cumulative breakdown over weeks and months.
{{% /tab %}}
{{< /tabs >}}
...
|---|----------|-------------|
| 21.01 | [Pre-Shift / Pre-Mo Warm-Up](pre-mo-warmup/) | General pre-shift preparation for physically demanding work |
