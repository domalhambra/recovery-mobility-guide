---
title: "Pre-Workout Warm-Ups"
weight: 20
description: "Pre-workout warm-up sequences."
---
...
{{< tabs tabTotal="3" >}}
{{% tab tabName="Ramp Up, Don't Stretch Out" %}}
Pre-workout prep should be dynamic — leg swings, arm circles, bodyweight squats — not long static holds. The goal is to increase tissue temperature and rehearse movement patterns, not chase flexibility. Save deep stretching for [after the workout](../../recovery/post-workout/).
{{% /tab %}}
{{% tab tabName="Match the Session" %}}
...
{{% /tab %}}
{{% tab tabName="Include Nervous System Prep" %}}
...
|---|----------|-------------|
| 22.01 | [Pre-Workout Warm-Up](pre-workout-warmup/) | General warm-up sequence for training sessions |
