---
title: "Sport-Specific Warm-Ups"
weight: 30
description: "Warm-ups for hiking, cycling, pack tests, and more."
---
...
{{< tabs tabTotal="3" >}}
{{% tab tabName="Activity-Specific Patterns" %}}
...
{{% /tab %}}
{{% tab tabName="Environment Affects Prep" %}}
...
{{% /tab %}}
{{% tab tabName="Prep the Weak Links" %}}
